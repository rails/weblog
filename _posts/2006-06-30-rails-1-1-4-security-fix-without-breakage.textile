...
---
The security fix from "Rails 1.1.3":http://weblog.rubyonrails.org/2006/6/27/rails-1-1-3-security-fix-and-minor-fixes might have closed the hole, but it also caused breakage for people with controllers in modules. We've fixed that now, so Rails 1.1.4 should work for any application that also ran under 1.1.2. We apologize for the problem with 1.1.3 and encourage everyone running 1.1.x to upgrade as soon as possible to this release.
