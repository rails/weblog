...
Over the past weeks the folks at <a href="http://travis-ci.org">Travis CI</a> have been working hard to provide a better experience to Rails continous integration and today we can happily announce that
<a href="http://travis-ci.org/#!/rails/rails">Rails is now testing on Travis CI</a>!
...
Travis CI is using a separate physical worker server (and a quite beefy one!) for running workers dedicated to Rails builds. This server has kindly been sponsored by the great folks over at <a href="http://enterprise-rails.com">Enterprise Rails</a>.
