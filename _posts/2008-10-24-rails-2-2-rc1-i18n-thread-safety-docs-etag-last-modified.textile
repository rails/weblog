...
Mike Gunderloy has compiled an exhaustive list and walk-through of many of the interesting new features for the <a href="http://guides.rubyonrails.org/2_2_release_notes.html">Rails 2.2 release notes</a>.

To help test the Rails 2.2 release candidate, please install with:<br/> <code>gem install rails -s http://gems.rubyonrails.org -v 2.2.0</code>
