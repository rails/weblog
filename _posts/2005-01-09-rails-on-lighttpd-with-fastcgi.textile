...
If you're interested in trying that out, TJ Vanderpoel has written an <a href="http://bougyman.com/miscfiles/RailsonDebian.html">extensive tutorial</a> on how to get Rails running with Lighttpd using FastCGI on Debian.