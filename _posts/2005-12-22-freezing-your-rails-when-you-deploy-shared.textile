...
The great news is that this is silly simple. If you're running 0.14.x or newer, you can simple do <code>rake freeze_gems</code>, and the current gems the system is used are unpacked into vendor/rails. Now the host can update as silly as it wants without affecting your application.