...
---
<a href="http://dev.rubyonrails.com/browser/tools/cia/trunk/">CIA</a> is a low-fi continuous integration server dedicated to testing Rails applications. It's less than 100 lines of code and very ugly. Thus, it has been somewhat of a well-kept secret. But it is indeed running CI for a number of shops including 37signals. Patrick Lenz has an <a href="http://poocs.net/articles/2005/05/22/setting-up-cia-continuous-integration-automater">article on how to set CIA up</a>.