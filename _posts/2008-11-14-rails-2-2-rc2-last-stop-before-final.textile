...
This release also conciedes with the fact that we've branches <a href="http://github.com/rails/rails/tree/2-2-stable">2-2-stable</a>, which means that master is now actually targeting Rails 2.3/3.0. There's also a tag available for this RC as <a href="http://github.com/rails/rails/tree/v2.2.1">v2.2.1</a>.

If you missed RC1, have a look at <a href="http://guides.rubyonrails.org/2_2_release_notes.html">the Rails 2.2 release notes</a> to see the major additions. You can see what's new since RC1 in <a href="http://weblog.rubyonrails.org/2008/11/7/this-week-in-edge-rails">these</a> <a href="http://weblog.rubyonrails.org/2008/11/14/this-week-in-edge-rails">two</a> This Week in Edge Rails.

To install, you must first have RubyGems 1.3.1:<br/><code>gem update --system</code>.

Then you can:<br/><code>gem install rails -s http://gems.rubyonrails.org</code>
