...
Liquid is packaged as a rails plugin for easy installation. In good rails style there is a <a href="http://leetsoft.com/rails/liquid-installation.mov">small movie</a> available showing how to install and use it. 