...
You can either grab the cool new <a href="http://wiki.rubyonrails.com/rails/show/HowtoInstallOnOSXTiger">Ruby on Rails installer for Tiger</a> that fixes Ruby itselfs and installs RubyGems, FCGI, and Rails in one fell swoop. Or if you already have stuff like RubyGems and the Rails installed, you can just grab this correction gem:

<pre>sudo gem install fixrbconfig
sudo fixrbconfig</pre>

<a href="http://www.chadfowler.com/index.cgi/Computing/Programming/Ruby/FixTiger.rdoc,v">Curtsey</a> of the RubyGems team.