...
---
Brian McCallister started working on a new Rails application and <a href="http://kasparov.skife.org/blog/src/ruby/new-things.html">discovered</a> the goodness that is the default logging setup:
...
It is indeed a powerful tool to have a <code>tail</code> running on while developing as you get an early warning system for performance problems and a minds eye into the internals of the system.