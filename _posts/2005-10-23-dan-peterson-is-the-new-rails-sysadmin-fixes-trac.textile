...
And wasting little time, he has already cleaned a few rough corners for performance and, more importantly, upgraded and fixed Trac -- the software that runs <a href="http://dev.rubyonrails.com/">dev.rubyonrails.com</a>. So no more timeouts, better performance, more features.